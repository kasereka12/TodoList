        ...
        <div class="container">
            <section class="row">
                <div id="show-user" class="col-12 content scaffold-show" role="main">
                    ...
                    <g:form resource="${this.user}" method="DELETE" class="d-flex justify-content-between">
                        ...
                        <g:link class="btn btn-info" action="index">Back To user List</g:link>
                    </g:form>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Password</td>
                            <td><g:fieldValue bean="${user}" field="password" /></td>
                        </tr>
                        <tr>
